...
import {
  ...
  Clock, Shield, Car as CarIcon, Download, AlertCircle, Calendar
} from 'lucide-react';
      ...
      <div className="grid gap-6">
        {myBookings.length > 0 ? (
          myBookings.map(booking => {
            ...
            return (
              <div key={booking.id} className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden flex flex-col md:flex-row">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-100">
                       ...
                       <div className="flex flex-col space-y-3 justify-center">
                          {isConfirmed && (
                             ...
                             >
                                <Navigation size={16} className="mr-2" /> Track Location
                             </button>
                          )}
                          <button
